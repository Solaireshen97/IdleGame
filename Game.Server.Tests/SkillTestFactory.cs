...
internal static class SkillTestFactory
{
    public static SkillCatalog Create() => new(Options.Create(new SkillOptions
    {
        ...
        [
            ...
            new SkillTalentNodeOptions { Code = "knight-fortitude", ProfessionCode = "knight", Name = "坚守", Description = "学习铁壁", SkillCode = "knight-wall", Cost = 1, Tier = 1, Column = 2, RequiredTalentType = TalentType.Health, RequiredTalentRank = 1 },
            ...
            new SkillTalentNodeOptions { Code = "cleric-ward", ProfessionCode = "cleric", Name = "守护祷言", Description = "学习庇护", SkillCode = "cleric-sanctuary", Cost = 1, Tier = 1, Column = 2, RequiredTalentType = TalentType.Health, RequiredTalentRank = 1 },
